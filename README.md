...
## Key Insights
1.SOM Grid Size Impact: Larger grids (20×20) produced more refined clusters with better classification accuracy but required more training time. Smaller grids (4×4) had higher quantization error and more dead neurons.


2.Dead Neurons: The 4×4 grid had 57 dead neurons (37.5% of total), while the 20×20 grid had zero dead neurons, demonstrating better data representation with larger topologies.


3.SLFN Implementation: Successfully implemented a neural network from scratch without deep learning frameworks, demonstrating understanding of:
...
4.Feature Importance: In the Titanic dataset, features like Sex, Fare, and Pclass showed strongest correlation with survival outcomes.
